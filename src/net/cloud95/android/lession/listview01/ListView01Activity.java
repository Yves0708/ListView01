package net.cloud95.android.lession.listview01;
...
public class ListView01Activity extends Activity {
    ...
    // 點擊與長按監聽類別
    private class MyItem implements AdapterView.OnItemClickListener,AdapterView.OnItemLongClickListener{
    	// 它是點擊長按監聽介面的方法
		...
		public boolean onItemLongClick(AdapterView<?> parent, View view,
				int position, long id) {//id是連結資料庫才會使用到
    ...
    private class MyScroll implements AbsListView.OnScrollListener{
		...
		public void onScrollStateChanged(AbsListView view, int scrollState) {
			...
			case OnScrollListener.SCROLL_STATE_IDLE:
				...
				if(isBottom){
					Toast.makeText(ListView01Activity.this, "Bottom", Toast.LENGTH_LONG).show();
				}
				break;
			//開始捲動
